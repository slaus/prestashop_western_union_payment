...
{else}
<form action="{$link->getModuleLink('wupayment', 'validation', [], true)}" method="post">
...
<p>
	...
	{if $currencies|@count > 1}
		{l s='We accept several currencies to be sent by Western Union.' mod='wupayment'}
		<br /><br />
	...
	{else}
		{l s='We accept the following currency to be sent by Western Union:' mod='wupayment'}&nbsp;<b>{$currencies.0.name}</b>
		<input type="hidden" name="currency_payement" value="{$currencies.0.id_currency}">
	{/if}
</p>
<p>
	{l s='Western Union account information will be displayed on the next page.' mod='wupayment'}
	<br /><br />
	<b>{l s='Please confirm your order by clicking \'I confirm my order\'' mod='wupayment'}.</b>
</p>
<p class="cart_navigation">
	<a href="{$link->getPageLink('order', true, NULL, "step=3")}" class="button_large">{l s='Other payment methods' mod='wupayment'}</a>
